...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Янв 13 2018 г., 11:28
...
(1, 'Playlist2', 'aibek', '2018-01-07 00:00:00'),
(2, 'Rock', 'aibek', '2018-01-11 00:00:00');

-- --------------------------------------------------------

--
-- Структура таблицы `playlistsSongs`
--
...
--
-- Дамп данных таблицы `playlistsSongs`
--
...
(1, 'Acoustic Breeze', 1, 1, 8, '2:37', 'assets/music/bensound-acousticbreeze.mp3', 1, 9),
(2, 'A new beginning', 1, 5, 1, '2:35', 'assets/music/bensound-anewbeginning.mp3', 2, 7),
...
(20, 'Of Elias Dream', 4, 7, 3, '4:58', 'assets/music/bensound-ofeliasdream.mp3', 3, 28),
...
(28, 'Tenderness ', 3, 3, 7, '2:03', 'assets/music/bensound-tenderness.mp3', 4, 4),
(29, 'The Lounge', 3, 3, 8, '4:16', 'assets/music/bensound-thelounge.mp3 ', 3, 21),
...
(1, 'aibek', 'Aibek', 'Jaksybaev', 'Aibek1@gmail.com', '2b3e939552f5aca34146f83e07ea4983', '2017-12-24 00:00:00', 'assets/images/profile-pics/head_emerald.png'),
(2, 'kongo', 'King', 'Kong', 'Kongo@gmail.com', '5f4dcc3b5aa765d61d8327deb882cf99', '2017-12-24 00:00:00', 'assets/images/profile-pics/head_emerald.png');
...
--
-- Индексы таблицы `playlistsSongs`
--
...
--
-- AUTO_INCREMENT для таблицы `playlistsSongs`
--
ALTER TABLE `playlistsSongs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
